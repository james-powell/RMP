...
for station in stations:
    ...
    try:
        ...
        #print('len(RH):',len(RH) )
        #print('len(windSpeed):',len(windSpeed) )
        #print('len(maxWind):', len(maxWind))
        #print('len(FFWI):',len(FFWI))
        ...
        for y, varName, fileName, thres in zip(varList, varListNames, varFileNames, threshold):        
            ...
            try:
                ...
                fig.savefig('%s/pngFiles/extremePercentilePics/%s_%s_Extreme_%s_24Hrs.png' % (filePath, station, endDate.year, fileName),  bbox_extra_artists=(lgd,), bbox_inches='tight')
